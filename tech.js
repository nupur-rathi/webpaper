...
let linkbuttons = document.querySelectorAll(".links");
for(let i=0; i<linkbuttons.length; i++)
{
  linkbuttons[i].addEventListener('click', function(){
  news = (linkbuttons[i]).textContent;
  news=news.charAt(0).toLowerCase()+news.slice(1);
  console.log(news);
  url = `${purl}https://newsapi.org/v2/everything?q=${news}&apiKey=29095409dba9478ba9fa8f6390a1d7f0`;
